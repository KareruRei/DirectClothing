...
public class HomeController {
        ...
        private DirectClothing clothingSystem = new DirectClothing();

        // Creating objects of supplier class
        private Address supplierAddress1 = new Address("8751 Paseo de Roxas", 
                                               "9/F, Equitable Bank Tower", 
                                               "Makati", 
                                               1473, 
                                               "Metro Manila", 
                                               "Philippines");
        private Address supplierAddress2 = new Address("551 Padre Faura St.", 
                                               "Ermita 1000", 
                                               "Manila", 
                                               2021, 
                                               "Metro Manila", 
                                               "Philippines");
        private Supplier supplier1 = new Supplier("Smith & Son, Inc.", supplierAddress1, "0937-436-2491");
        private Supplier supplier2 = new Supplier("Specter Fabric, Inc.", supplierAddress2, "0925-214-6523");

        // Creating objects of the item class
        private Product tshirt = new Product("Medium-size, Cotton Fabric T-shirt", "10XP3XQ07VVMCVB9", 439, supplier1);
        private Product pants = new Product("Gray Slim Fit Khaki pants", "1JTHTJM4VUP20GV9", 547, supplier1);
        private Product jacket = new Product("Beige Oversized hoodie jacket", "1ANJCY4437WRWHQ9", 401, supplier1);
        private Product cardigan = new Product("Loose Knit Sweater Cardigan", "1IF7MF9IPDD4VET9", 387, supplier2);
        private Product skirt = new Product("Long Cotton Skirt Casual", "12CZB14MEC8LIYD9", 461, supplier2);
        private Product polo = new Product("XL Beige Polo Shirt", "1S51UGMNMPFAF099", 526, supplier2);


        // Creating objects of the catalog class
        private Catalog.Item[] catalogItems1 = {
        ...
        private Catalog.Item[] catalogItems2 = {
        ...
        private Catalog catalog1 = new Catalog("DirectClothing Catalog 1", "2URJYRLU1PP5", catalogItems1, Date.create(2024, 2, 14));
        private Catalog catalog2 = new Catalog("DirectClothing Catalog 2", "2G7Q5EOBNDG5", catalogItems2, Date.create(2024, 11, 27));
